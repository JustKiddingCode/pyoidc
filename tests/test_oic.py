...
class TestClient(object):
    ...
    def test_client_id(self):
        ...
        self.client.parse_response(AuthorizationResponse, resp, sformat="urlencoded")
        args = {
            "code": "code",
    ...
    def test_construct_RegistrationRequest(self):
        ...
        crr = self.client.construct_RegistrationRequest(request_args=request_args)
        assert _eq(
            crr.keys(),
            [
                "application_name",
...
class TestServer(object):
    ...
    def test_parse_end_session_request(self):
        ...
        request = self.srv.parse_end_session_request(query=esreq.to_urlencoded())
    ...
    def test_parse_open_id_request(self):
        ...
        claims_req = ClaimsRequest(userinfo=userinfo_claims, id_token=id_token_claims)
        ...
        request = self.srv.parse_open_id_request(data=oidreq.to_json(), sformat="json")
...
def test_request_1():
    ...
    areq = (
        "redirect_uri=https%3A%2F%2Fnode-openid-client.dev%2Fcb&request"
